...
> 데이터 흐름·배포 아키텍처·클라우드/컨테이너·보안 상세: **[④ 시스템 구성도](llm_wiki/산출물/04_시스템_구성도.md)**
...
> 화면 인벤토리(S-ID)·반응형·인증 흐름·LLM UX 상세: **[② 화면설계서](llm_wiki/산출물/02_화면설계서.md)**
...
└─ llm_wiki/             # 문서
   ├─ 산출물/            # ★ 평가 산출물 (요구사항·화면설계·LLM웹앱·시스템구성도·테스트보고서)
   ├─ internal/          # 설계 노트 (구현방향·기획·데이터모델·RAG 성능평가·coding_state 등)
   └─ screenshots/       # 시연 캡처
```
...
> 상세: **[④ 시스템 구성도](llm_wiki/산출물/04_시스템_구성도.md)** · 배포·재현성 검증 **[⑤ 테스트 보고서 부록 A](llm_wiki/산출물/05_테스트계획_및_결과보고서.md)**
...
**평가 산출물** — 세부 내용은 아래 문서에 정리했습니다 (`llm_wiki/산출물/`):

| # | 산출물 | 문서 |
|---|---|---|
| 1 | 요구사항 정의서 (+유스케이스·추적성 매트릭스) | [`01_요구사항_정의서.md`](llm_wiki/산출물/01_요구사항_정의서.md) |
| 2 | 화면설계서 (화면 인벤토리·반응형·인증 흐름·LLM UX·시연) | [`02_화면설계서.md`](llm_wiki/산출물/02_화면설계서.md) |
| 3 | 개발된 LLM 연동 웹 애플리케이션 (FE·비동기·백엔드·배포) | [`03_LLM연동_웹애플리케이션.md`](llm_wiki/산출물/03_LLM연동_웹애플리케이션.md) |
| 4 | 시스템 구성도 (데이터 흐름·배포·클라우드·보안) | [`04_시스템_구성도.md`](llm_wiki/산출물/04_시스템_구성도.md) |
| 5 | 테스트 계획 및 결과 보고서 (+검증 절차·시나리오 부록) | [`05_테스트계획_및_결과보고서.md`](llm_wiki/산출물/05_테스트계획_및_결과보고서.md) |

- 산출물 인덱스: [`00_산출물_인덱스.md`](llm_wiki/산출물/00_산출물_인덱스.md)
- 설계 노트(구현방향·기획·데이터모델·RAG 성능평가·coding_state 등): [`llm_wiki/internal/`](llm_wiki/internal/)
